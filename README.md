...
- **Styling:** Tailwind CSS, CSS Modules, BEM, Sass (SCSS), Bootstrap, PostCSS
- **Methodologies:** BEM
...
- **Data & APIs:** REST APIs, JSON
- **Package Managers:** npm, pnpm
- **Build Tools:** Vite, Parcel
- **Code Quality:** Biome, ESLint, Prettier, Stylelint
...
- **Frontend Developer Intern** @ PREAX
